                    ...
                    <div className="container mx-auto px-6">
                        <div className="grid md:grid-cols-3 gap-12">
                            <div className="md:col-span-2">
                                <h2 className="text-3xl font-bold font-display text-primary-text mb-4">Build the Exact Software Your Business Needs</h2>
                                <p className="text-lg text-gray-700 mb-6">
                                    Don't settle for off-the-shelf software that doesn't fit. We analyze your unique workflow and build
                                    powerful, custom-fit software (like CRMs, ERPs, or internal tools) to automate your operations, reduce
                                    errors, and scale your business.
                                </p>
                                <p className="text-lg text-gray-700 mb-6">
                                    Our process focuses on reliability and timeliness. We build solutions that are not just effective today
                                    but are scalable for tomorrow, ensuring your investment continues to pay off as your company grows.
                                </p>

                                <h3 className="text-2xl font-bold font-display text-primary-text mb-4 mt-10">Who Is This For?</h3>
                                <p className="text-lg text-gray-700">This service is perfect for businesses and organizations that are:</p>
                                <ul className="list-disc list-inside text-lg text-gray-700 space-y-2 mt-4">
                                    <li>Still using spreadsheets to manage core operations.</li>
                                    <li>Frustrated with software that doesn't "talk" to your other tools.</li>
                                    <li>Startups needing a Minimum Viable Product (MVP) built right.</li>
                                    <li>Looking to automate repetitive, manual tasks to save time and money.</li>
                                </ul>
                            </div>
                            ...
                            <aside className="bg-light-bg p-8 rounded-lg shadow-lg transition duration-300 hover:shadow-xl hover:-translate-y-1">
                                <div className="flex flex-col items-center mb-6">
                                    <div className="rounded-full bg-primary-blue p-1">
                                        <div className="rounded-full bg-white p-1">
                                            <img src="/images/Software solution.jpeg" alt="Software solution illustration" className="w-24 h-24 md:w-28 md:h-28 rounded-full object-cover" loading="lazy" decoding="async" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <ul className="space-y-4">
                                    <li className="flex items-start">
                                        ...
                                        <span><strong>Full-Stack Development</strong> (Frontend & Backend)</span>
                                    </li>
                                    <li className="flex items-start">
                                        <svg className="h-6 w-6 text-primary-accent flex-shrink-0 mr-3 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                        <span><strong>Database Design</strong> & Integration</span>
                                    </li>
                                    <li className="flex items-start">
                                        <svg className="h-6 w-6 text-primary-accent flex-shrink-0 mr-3 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                        <span><strong>API Development</strong> & 3rd-Party Integration</span>
                                    </li>
                                    <li className="flex items-start">
                                        <svg className="h-6 w-6 text-primary-accent flex-shrink-0 mr-3 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                        <span><strong>Cloud Deployment</strong> & Management (Vercel, AWS, etc.)</span>
                                    </li>
                                </ul>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    ...
                                    <span className="font-mono text-[10px] px-2.5 py-1 bg-cyan-950/5 text-primary-blue rounded border border-cyan-900/10">// Vite</span>
                                    <span className="font-mono text-[10px] px-2.5 py-1 bg-cyan-950/5 text-primary-blue rounded border border-cyan-900/10">// PostgreSQL</span>
                                    ...
                                    <span className="font-mono text-[10px] px-2.5 py-1 bg-cyan-950/5 text-primary-blue rounded border border-cyan-900/10">// AWS</span>
                                </div>
                            </aside>
                        </div>
                    </div>
