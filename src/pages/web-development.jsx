                    ...
                    <div className="container mx-auto px-6">
                        <div className="grid md:grid-cols-3 gap-12">
                            <div className="md:col-span-2">
                                <h2 className="text-3xl font-bold font-display text-primary-text mb-4">Modern, High-Performance Web Solutions</h2>
                                <p className="text-lg text-gray-700 mb-6">
                                    Your website is your digital front door. It needs to be professional, fast, and reliable. We create fast,
                                    secure, and responsive websites that look professional on every device, from phones to desktops.
                                </p>
                                <p className="text-lg text-gray-700 mb-6">
                                    Whether you need a corporate information site, a complex e-commerce platform, or a secure web application,
                                    our team uses modern technologies to build a web presence you can be proud of.
                                </p>
                                ...
                                <ul className="list-disc list-inside text-lg text-gray-700 space-y-2 mt-4">
                                    <li>Need a new, professional website from scratch.</li>
                                    <li>Have an outdated website that isn't mobile-friendly.</li>
                                    <li>Want to start selling products online with an e-commerce store.</li>
                                    <li>Need a custom web-based tool for customers or internal teams.</li>
                                </ul>
                            </div>
                            ...
                            <aside className="bg-light-bg p-8 rounded-lg shadow-lg transition duration-300 hover:shadow-xl hover:-translate-y-1">
                                <div className="flex flex-col items-center mb-6">
                                    <div className="rounded-full bg-primary-blue p-1">
                                        <div className="rounded-full bg-white p-1">
                                            <img src="/images/Web Dev.jpeg" alt="Web Development illustration" className="w-24 h-24 md:w-28 md:h-28 rounded-full object-cover" loading="lazy" decoding="async" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <ul className="space-y-4">
                                    <li className="flex items-start">
                                        ...
                                        <span><strong>Responsive Corporate Websites</strong></span>
                                    </li>
                                    <li className="flex items-start">
                                        <svg className="h-6 w-6 text-primary-accent flex-shrink-0 mr-3 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                        <span><strong>E-Commerce Platforms</strong> (Shopify, WooCommerce, Custom)</span>
                                    </li>
                                    <li className="flex items-start">
                                        <svg className="h-6 w-6 text-primary-accent flex-shrink-0 mr-3 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                        <span><strong>Content Management Systems</strong> (CMS)</span>
                                    </li>
                                    <li className="flex items-start">
                                        <svg className="h-6 w-6 text-primary-accent flex-shrink-0 mr-3 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                ...
                <section id="contact" className="bg-light-bg py-20 fade-in-section">
                    <div className="container mx-auto px-6 text-center">
                        ...
                        <p className="text-lg text-gray-700 max-w-2xl mx-auto mb-8">
                            Let's create a web presence that drives growth for your business.
                        </p>
